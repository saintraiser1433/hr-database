...
import { assignStatusTeamlead, fetchAllEmployeesByDeptID, fetchAllEmployeesWithEvaluationStatus, fetchEmployeeInformationById, fetchRequirementByEmpID, insertEmptoRequire, removeEmpToRequire, unassignStatusTeamlead, updateEmpInformation, updateEmpRequireStatus } from '../controller/employee.ts';
...
route.get('/evaluate/:deptId',fetchAllEmployeesWithEvaluationStatus)
